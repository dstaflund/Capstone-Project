...
public final class GeomemorialDbContract {
    ...
    public static class NtsSheet implements BaseColumns {
    ...
    public static class ProvincialCount implements BaseColumns {
    ...
    public static class NtsSeriesCounts implements BaseColumns {
    ...
    public static class NtsAreaCounts implements BaseColumns {
    ...
    public static class NtsSheetCounts implements BaseColumns {
    ...
    public static class MarkerInfo implements BaseColumns {
    ...
    public static class SearchSuggestions implements BaseColumns {
